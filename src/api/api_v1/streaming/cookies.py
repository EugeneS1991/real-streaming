# Cookie setting moved to GTM template - this module is no longer used
# The __uid__ cookie is now set by the GTM template (ensureUidCookie function)
# when the page loads, which allows it to work across different domains.
